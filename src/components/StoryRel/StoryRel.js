...
const StoryRel = () => {
    return (
        <div className='storyRel' >
            <Myday image={student5} title="test" src="https://www.freepik.com/premium-photo/young-cheerful-programmer-with-headphones-looking-you-with-smile-during-work-new-software-office_10686287.htm#query=programmer&from_query=pogrammer&position=34&from_view=search" />
